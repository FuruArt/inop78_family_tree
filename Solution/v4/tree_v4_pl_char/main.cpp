...
void printMenu()
{
	...
	cout << "Dodaj relacjê miêdzy osobami  " << menuTab[3] << endl;
...
Person formRelative(bool gender)
{
    ...
    {
        system("cls");
        cout<<"B³¹d, sporóbuj ponownie" << endl;
        cout << "WprowadŸ datê urodzenia (DD-MM-RRRR): ";
        cin >> birthDate;
    }
	...
	cin >> decision;
	if (decision == 'n') {
		cout << "WprowadŸ datê œmierci (DD-MM-RRRR): ";
        cin >> deathDate;
	...
	return Person(firstName,lastName,familyName,Date(birthDate), Date(deathDate),gender);
}
...
Person form(string relationsip, bool user)
{
	...
	return Person (firstName, lastName, familyName, Date(birthDate),Date(deathDate), gender, relationsip);
}
...
void menu(int &i, char &x)
{
	...
	do
    {
		...
		case 13: //enter
            ...
            {
				system("cls");
				cout<<"(Aby anulowaæ, wciœnij enter nie wprowadzaj¹c ¿adnego znaku)"<<endl;
				string firstName, lastName;
				cout << "Podaj imiê: ";
				cin.clear();
				fflush(stdin);
				...
				if(!(firstName.empty()))
                {
                    ...
                    cin >> lastName;
                    system("cls");
                    if (tree.findMember(firstName, lastName)._map == 404)
                    {
                        cout << "Nie znaleziono" << endl;
                    }
			...
			if (i == 2)//edytuj czlonka rodziny
            {
				...
				if(!(firstName.empty()))
                {
                    ...
                    if (seek._map == 404)
                        ...
                        cout << "Czy na pewno chcesz edytowaæ "<<firstName<<"? (t/n): ";
                        char dec;
                        cin >> dec;
                        if (dec == 't') {
			...
			if (i == 4)	//usun czlonka rodziny
            {
				...
				if(!(firstName.empty()))
                {
                    ...
                    {
                        system("cls");
                        cout<<"Nie mo¿esz usun¹æ siebie"<<endl;
                    }
                    else
                    {
                        cout << "Czy na pewno chcesz usun¹æ? "<<firstName<<" (t/n) ";
                        char dec;
                        cin >> dec;
                        if (dec == 't')
                        {
                    ...
                    cout << "Poprawnie usuniêto"<<endl;
                    cout << "Strza³ka w górê aby wróciæ";
				}
				else
                {
                    system("cls");
